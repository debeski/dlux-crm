...
- Django POS/ERP v0.7.2 (untagged) after tagged v0.7.1; pins `django-lux[updater]==1.8.6`; repo `debeski/dlux-crm`, image `debeski/dlux-crm:sales`; apps: finance, catalog, sales, common, public_catalog.
